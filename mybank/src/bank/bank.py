...
class Bank:
    ...
    def create_account(self, password, firstname, lastname):
        bank = Bank(password, firstname, lastname, self.__account_number + 1)
        if password != "":
    ...
    def get_balance(self, password, account_number):
        ...
        if index is -1:
            ...
            self.__bank_list[index].get_balance(password)
